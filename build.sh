...
west build -d build/right -b seeeduino_xiao_ble -- -DSHIELD=cheakee_right -DZMK_CONFIG="/workspaces/zmk-config/config" -DZMK_EXTRA_MODULES="/workspaces/zmk-config/zmk-driver-paw32xx"
